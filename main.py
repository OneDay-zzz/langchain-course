...
def main():
    ...
    summary_promopt_template = PromptTemplate(
        input_variables=["information"],
        template=summary_template,
    )

    chain = summary_promopt_template | model  # chain object
